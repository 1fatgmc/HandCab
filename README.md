...
- NOTE:  There are items shown below that are striked out.  They work on the WiTcontroller software but not the software for the HandCab because of the
  - use of the 'pots' on the HandCab.  One can load the WiTcontroller software and use the throttle with the encoder but then the pots are non-functional.
