...
// *******************************************************************************************************************
// Throttle Pot Numbers you must define.
//
...
//
// The next line has values generated by the Read_Pot_Values program you run first.  Numbers shown are Sumner's.  Run the Read_Pot-Values program to generate yours. 
 #define THROTTLE_POT_NOTCH_VALUES {1111,1347,1591,1833,2105,2379,2622,2837} // Enter these numbers from the numbers generated by Read_Pot_Values program you run first.
//
// The next line are the speed steps you want for eash of the 8 throttle notches.  The ones shown are what I use.  You can use any speed step (0-126) for a notch.
// I speed speed match my speed steps to scale speedl.  Speed step 4 = 4 scale mph and so on up to speed step 65 is 65 mph.  You can use what works for you.

 #define THROTTLE_POT_NOTCH_SPEEDS {4,10,15,25,35,45,55,65}  // 0-126 These numbers will be the speed step for each of the 8 throttle notches.  Change them to what you want.
...
// 
// *******************************************************************************************************************
// Reverser Pot Numbers you must define.
//
 #define REVERSER_POT_PIN 35
//
// The next line has values generated by the Read_Pot_Values program you run first.  Numbers shown are Sumner's.  Run the Read_Pot-Values program to generate yours.
 #define REVERSER_POT_VALUES {981,2141}     // Numbers are generated by Read_Pot-Values program change the numbers to the left to your numbers.

// *******************************************************************************************************************
// brake Pot Numbers you must define.
//
 #define BRAKE_POT_PIN 34
//
// The next line has values generated by the Read_Pot_Values program you run first.  Numbers shown are Sumner's.  Run the Read_Pot-Values program to generate yours.

// EXAMPLE: #define BRAKE_POT_VALUES  {841,1224,1602,1980,2365}  //Numbers shown are Sumner's.  Run the Read_Pot-Values program to generate yours.
...
//
// These numbers will setup the brake delay times.  Left to right.  Less braking to more braking as the brake is applied.
//  
 #define BRAKE_DELAY_TIMES {500,200,125,50,25,0}   // Numbers to the left are Sumner's. Start with these then experiment some and use numbers that work for you.
//
...
// one that is selected will set the current acceleration momentum.
 #define ACCELLERATION_DELAY_TIMES {182,415,600} // Numbers to the left are Sumner's. Start with these then experiment some and use numbers that work for you.
//
