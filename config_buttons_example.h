...
// *******************************************************************************************************************
// Optional linear Throttle Pot.  i.e. No Notches
// 
...
// b) uncomment and adjust the lines below as needed
//
// note: There MUST be only two values for the two defines

// #define USE_THROTTLE_NOTCHES false
// #define THROTTLE_POT_NOTCH_VALUES {0000,0000} // Enter these numbers from the numbers generated by Read_Pot_Values program you run first. It is only the first and last values you want.
// #define THROTTLE_POT_NOTCH_SPEEDS {0,126}  // Use values between 0-126. These numbers will be the speed step for the beginning, and the end of the pot range. The first MUST always be 0

// EXAMPLE: #define THROTTLE_POT_NOTCH_VALUES {1111,2837} // Run the Read_Pot-Values program to generate yours.
// EXAMPLE: #define THROTTLE_POT_NOTCH_SPEEDS {0, 126}    // Numbers to left give the locos their full speed range

// If the throttle bounces at zero and maximum travel, uncomment and increase this value
