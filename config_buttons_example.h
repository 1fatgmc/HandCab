...
// #define REVERSER_VALUES {981,2141};               // Numbers generated by Generate_Throttle__Brake__Reverser__Numbers program.

// *******************************************************************************************************************
// momentum and brake values
// #define BRAKE_DELAY_TIMES {500,250,150,100,25,1};  // These numbers will setup the brake delay times.  Left to right.  
//                                                   // Less braking to more braking as the brake is applied. 
// #define ACCELLERATION_DELAY_TIMES {100,500,1000};  // The numberes you input here will set up the accelleration momentum.  
