...
// EXAMPLE: #define THROTTLE_POT_NOTCH_SPEEDS {4,10,15,25,35,45,55,65}  // Numbers to left are Sumner's & after speed matching the loco to the throttle are 4 mph to 65 mph. 
 ...
 #define THROTTLE_POT_NOTCH_SPEEDS {00,00,00,00,00,00,00,00}  // Use 0-126. These numbers will be the speed step for each of the 8 throttle notches.  Change them to what you want.
